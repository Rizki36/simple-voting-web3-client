    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            You are about to submit this proposal to the blockchain. This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4">
          ...
          <div className="mb-4">
            ...
            <p>{proposal.endDate ? format(proposal.endDate, "PPP") : "Not set"}</p>
          </div>
          
          <div className="bg-slate-800 p-3 rounded-md mt-4 text-xs">
            <p className="font-medium text-slate-300 mb-1">Transaction Information:</p>
